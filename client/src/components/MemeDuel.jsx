  ...
  return (
    <div className="relative flex flex-col items-center justify-center my-16">
      ...
      <div className="w-full flex flex-col md:flex-row gap-12 md:gap-16 items-center justify-center">
        ...
        >
          <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-cyan-500 via-purple-500 to-cyan-400 flex items-center justify-center text-4xl md:text-5xl font-orbitron text-white shadow-2xl drop-shadow-[0_0_32px_#00fff7] animate-vs-glow select-none">
            VS
          </div>
          <style>{`
            @keyframes vs-glow {
